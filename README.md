...
- **Website-by credit (`.site-footer__credit`)** under the legal line on all 13 footer pages: "WEBSITE BY" + the **Designmynt** logo (`i.ibb.co/G4yX68Hj/...`, Jay's studio). ⚠️ Link currently a placeholder `https://designmynt.com` — confirm the real URL. Logo on ibb → localize before launch.
...
- **Video:** `assets/video/time-capsule-90s.mp4` (852×480, ~24s, **compressed 16.6MB → 3.56MB**, AAC audio). JS = guarded IIFE at end of `main.js`.
